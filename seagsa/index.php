		...
		*/
		...
		{ 
			...
			if("2"==$cars[$i]['gs$cell']['col'] ){
				...
				//echo 	"<h1>".$cars[$i]['gs$cel']['col']."</h1><br><br>";
         ...
         <div class="links">
            <ul>
			  <?php if( isset( $facebook  )  )  {?>
               ...
               <?php if( isset( $facebook  )  )  {?>
			   <li><a href="<?php echo $facebook ;?>" target="_blank" class="linkedin"><img src="public/images/linkedin-icon.png" alt="">
			   </a></li>
               <?php }	?>

			 <?php if( isset( $linkedin  )  )  {?>
			  <li><a href="<?php echo $linkedin ;?>" target="_blank" class="googleplus">
